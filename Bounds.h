...
public:
	...
	static const int xBounds = 400;	// distance the player/camera can travel left/right
	static const int YBounds = 200;	// distance the player/camera can travel up/down
